                ...
                while (running) {
                    ...
                    if (message != null && messageListener != null) {
                        //call the method messageReceived from ServerBoard class
                       	if (!message.toString().equalsIgnoreCase("Disconnect")){
                    		   messageListener.messageReceived(message);
                    		   Message msg = new Message();
                    		   msg.header.type = Message.DATA;
                    		   msg.header.sender = "Server";
                    		   msg.header.receiver = "Client";
                    		   msg.body.addField("msg", Common.mReplies.get(mRandom.nextInt(5)));
                    		   sendMessage(msg);
                      	} else {
