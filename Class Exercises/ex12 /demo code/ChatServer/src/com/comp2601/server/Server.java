...
public class Server extends Thread {
	...
	//TODO:  Set port
    private static final int SERVERPORT = 3001; //FOR NOW
    ...
    public void run() {
        ...
        try {
            System.out.println("S: Listening on port: "+SERVERPORT);
            ...
            try {
                ...
                mOut = new PrintWriter(new BufferedWriter(new OutputStreamWriter(client.getOutputStream())), true);  //for now

                //read the message received from client
                //using a BufferedReader
                BufferedReader in = new BufferedReader( new InputStreamReader(client.getInputStream())); //for now
