...
public class MainActivity extends AppCompatActivity {
    ...
    private String mServerIpAddress = "http://10.0.2.2:3000"; //localhost for emulator use
    ...
    private void requestMove(String aDirection){
        ...
        String mQueryString = mServerIpAddress + "/move?word=" + mName + "&direction=" + aDirection;
        ...
        new ServerRequestTask().execute(mQueryString);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonSendLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String mQueryString = mServerIpAddress + "/add?word=" + mName;
    ...
    private class ServerRequestTask extends AsyncTask<String, Integer, String> {
